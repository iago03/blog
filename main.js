...
var cardInfo = [
    new info("1","./img/img-girl1.webp","Admin","июля",8,1,"Как выбрать идеальный принт","Вы уже придумали дизайн для блога? Попробуйте каждый из наших восьми макетов, чтобы скомпоновать содержание наилучшим образом.",8,9),
    new info("2","./img/img-girl2.webp","Admin","июля",8,1,"Модная штучка: жакет","Вы уже придумали дизайн для блога? Попробуйте каждый из наших восьми макетов, чтобы скомпоновать содержание наилучшим образом.",3,9),
    new info("3","./img/clothes.webp","Admin","июля",8,1,"5 осенних образов, которые вы полюбите","Вы уже придумали дизайн для блога? Попробуйте каждый из наших восьми макетов, чтобы скомпоновать содержание наилучшим образом.",7,9)
]
